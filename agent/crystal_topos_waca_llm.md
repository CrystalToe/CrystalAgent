...
# 21 Haskell modules. 166 observables. 96 quantum operators.
...
### analysis Scan (1 module, 74 new observables)

| Module | Key Functions | Domain |
|--------|--------------|--------|
| CrystalanalysisScan | 74 new: mesons, baryons, quark masses, τ, EW, nuclear, moments | analysis scan |
