...
### analysis Scan (1 module, 44 new observables)

| Module | Key Functions | Domain |
|--------|--------------|--------|
| CrystalanalysisScan | 44 new: mesons, baryons, quark masses, τ, EW, nuclear, moments | analysis scan |
