...
# 21 Haskell modules. 137 observables. 96 quantum operators.
...
### analysis Scan (1 module, 45 new observables)

| Module | Key Functions | Domain |
|--------|--------------|--------|
| CrystalanalysisScan | 45 new: mesons, baryons, quark masses, τ, EW, nuclear, moments | analysis scan |
