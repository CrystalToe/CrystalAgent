...
- **CrystalAtoms** —      222 lines, 0 prove functions
...
- **CrystalFold** —      553 lines, 0 prove functions
- **CrystalFriedmann** —      640 lines, 26 prove functions
- **CrystalFullTest** —      619 lines, 4 prove functions
- **CrystalGauge** —      309 lines, 36 prove functions
- **CrystalGR** —      742 lines, 46 prove functions
...
- **CrystalQInfo** —      468 lines, 30 prove functions
- **CrystalQMeasure** —      187 lines, 0 prove functions
- **CrystalQuantum** —      433 lines, 20 prove functions
...
- **ObservableAll** —       71 lines, 0 prove functions
- **ObservableAlphaProton** —      235 lines, 0 prove functions
- **ObservableBio** —      187 lines, 0 prove functions
- **ObservableCondensed** —      197 lines, 0 prove functions
- **ObservableCosmo** —      211 lines, 0 prove functions
- **ObservableFluid** —      135 lines, 0 prove functions
- **ObservableGauge** —      179 lines, 0 prove functions
...
- **CrystalAtoms.lean** — 55 theorems
- **CrystalAudit.lean** — 15 theorems
- **CrystalAxiom.lean** — 16 theorems
- **CrystalBenchmark.lean** — 3 theorems
- **CrystalBio.lean** — 17 theorems
- **CrystalCFD.lean** — 12 theorems
...
- **CrystalDiffusion.lean** — 50 theorems
...
- **CrystalFold.lean** — 10 theorems
- **CrystalFriedmann.lean** — 37 theorems
- **CrystalFullTest.lean** — 15 theorems
- **CrystalFundamentals.lean** — 52 theorems
- **CrystalGauge.lean** — 18 theorems
- **CrystalGR.lean** — 29 theorems
- **CrystalGravity.lean** — 35 theorems
- **CrystalGravityDyn.lean** — 34 theorems
- **CrystalGW.lean** — 19 theorems
...
- **CrystalPlasma.lean** — 15 theorems
- **CrystalProtein.lean** — 14 theorems
...
- **CrystalQEntangle.lean** — 9 theorems
- **CrystalQFT.lean** — 23 theorems
- **CrystalQGates.lean** — 8 theorems
- **CrystalQHamiltonians.lean** — 19 theorems
- **CrystalQInfo.lean** — 21 theorems
- **CrystalQMeasure.lean** — 11 theorems
- **CrystalQSimulation.lean** — 20 theorems
- **CrystalQuantum.lean** — 19 theorems
- **CrystalRendering.lean** — 6 theorems
- **CrystalRiemann.lean** — 15 theorems
- **CrystalRigid.lean** — 20 theorems
...
- **ObservableAlphaProton.lean** — 11 theorems
- **ObservableBio.lean** — 12 theorems
- **ObservableCondensed.lean** — 14 theorems
- **ObservableCosmo.lean** — 17 theorems
- **ObservableFluid.lean** — 10 theorems
- **ObservableGauge.lean** — 20 theorems
- **ObservableMass.lean** — 23 theorems
- **ObservableMath.lean** — 8 theorems
- **ObservableMixing.lean** — 21 theorems
...
- **CrystalAtoms.agda** — 43 proofs
- **CrystalAudit.agda** — 14 proofs
- **CrystalAxiom.agda** — 11 proofs
- **CrystalBenchmark.agda** — 3 proofs
- **CrystalBio.agda** — 13 proofs
- **CrystalCFD.agda** — 12 proofs
...
- **CrystalDiffusion.agda** — 50 proofs
...
- **CrystalFold.agda** — 10 proofs
- **CrystalFriedmann.agda** — 32 proofs
- **CrystalFullTest.agda** — 10 proofs
- **CrystalFundamentals.agda** — 35 proofs
- **CrystalGauge.agda** — 12 proofs
- **CrystalGR.agda** — 27 proofs
- **CrystalGravity.agda** — 32 proofs
...
- **ObservableAlphaProton.agda** — 12 proofs
- **ObservableBio.agda** — 18 proofs
- **ObservableCondensed.agda** — 18 proofs
- **ObservableCosmo.agda** — 20 proofs
- **ObservableFluid.agda** — 11 proofs
- **ObservableGauge.agda** — 26 proofs
- **ObservableMass.agda** — 24 proofs
- **ObservableMath.agda** — 10 proofs
- **ObservableMixing.agda** — 25 proofs
