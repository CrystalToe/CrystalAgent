...
-- refactored: was CrystalEngine. Engine wiring (§10a) stripped — time-dependent.
-- Pure structural proofs only. All atoms from CrystalAxiom.
...
-- §10a ENGINE WIRING: stripped (time-dependent, moved to CrystalDynamicEngine)
...
quantumAudit = do
  ...
  putStrLn "  ALL atoms from CrystalAxiom. Engine wiring stripped (time-dependent)."
  putStrLn ""
  putStrLn "================================================================"
  where
