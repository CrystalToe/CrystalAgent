...
### 152 Physical Constants from Two Primes. Zero Free Parameters.
...
This repository contains a complete, proof-carrying implementation of the **Crystal Topos** — a framework that derives 152 physical constants from a single finite-dimensional algebra:
...
| Metric | Value |
|--------|-------|
| Total observables | **152** |
| Sub-1% accuracy | **152 / 152** (100%) |
...
### Compile the analysis Scan (60 new observables)
```bash
...
└── haskel/                            ← All Haskell source code + proofs
    ...
    │
    ├── ─── analysis SCAN (60 new observables) ───
    │   CrystalanalysisScan.hs            ← 60 new: mesons, baryons, thermo, fluids, confinement, biology
...
| File | Size | Purpose |
|------|------|---------|
| `crystal_topos_waca_llm_compact.md` | 4 KB | Knowledge base: module table, derivation chain, all 152 observables |
